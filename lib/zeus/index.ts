...
delete_robot_order?: [{	/** filter the rows which have to be deleted */
	where:ValueTypes["robot_order_bool_exp"]},ValueTypes["robot_order_mutation_response"]],
delete_robot_order_by_pk?: [{	order_id:string},ValueTypes["robot_order"]],
delete_robot_product?: [{	/** filter the rows which have to be deleted */
...
delete_robot_product_designer?: [{	/** filter the rows which have to be deleted */
	where:ValueTypes["robot_product_designer_bool_exp"]},ValueTypes["robot_product_designer_mutation_response"]],
delete_robot_product_designer_by_pk?: [{	eth_address:string,	product_id:string},ValueTypes["robot_product_designer"]],
...
update_robot_order?: [{	/** increments the numeric columns with given value of the filtered values */
	_inc?:ValueTypes["robot_order_inc_input"] | null,	/** sets the columns of the filtered rows to the given values */
	_set?:ValueTypes["robot_order_set_input"] | null,	/** filter the rows which have to be updated */
	where:ValueTypes["robot_order_bool_exp"]},ValueTypes["robot_order_mutation_response"]],
...
update_robot_product_designer?: [{	/** increments the numeric columns with given value of the filtered values */
	...
	_set?:ValueTypes["robot_product_designer_set_input"] | null,	/** filter the rows which have to be updated */
	where:ValueTypes["robot_product_designer_bool_exp"]},ValueTypes["robot_product_designer_mutation_response"]],
update_robot_product_designer_by_pk?: [{	/** increments the numeric columns with given value of the filtered values */
	_inc?:ValueTypes["robot_product_designer_inc_input"] | null,	/** sets the columns of the filtered rows to the given values */
	_set?:ValueTypes["robot_product_designer_set_input"] | null,	pk_columns:ValueTypes["robot_product_designer_pk_columns_input"]},ValueTypes["robot_product_designer"]],
...
robot_order?: [{	/** distinct select on columns */
	...
	where?:ValueTypes["robot_order_bool_exp"] | null},ValueTypes["robot_order"]],
robot_order_aggregate?: [{	/** distinct select on columns */
	distinct_on?:ValueTypes["robot_order_select_column"][],	/** limit the number of rows returned */
	limit?:number | null,	/** skip the first n rows. Use only with order_by */
	offset?:number | null,	/** sort the rows by one or more columns */
	order_by?:ValueTypes["robot_order_order_by"][],	/** filter the rows returned */
	where?:ValueTypes["robot_order_bool_exp"] | null},ValueTypes["robot_order_aggregate"]],
robot_order_by_pk?: [{	order_id:string},ValueTypes["robot_order"]],
robot_product?: [{	/** distinct select on columns */
	...
	where?:ValueTypes["robot_product_bool_exp"] | null},ValueTypes["robot_product"]],
robot_product_aggregate?: [{	/** distinct select on columns */
	distinct_on?:ValueTypes["robot_product_select_column"][],	/** limit the number of rows returned */
	limit?:number | null,	/** skip the first n rows. Use only with order_by */
	offset?:number | null,	/** sort the rows by one or more columns */
	order_by?:ValueTypes["robot_product_order_by"][],	/** filter the rows returned */
	where?:ValueTypes["robot_product_bool_exp"] | null},ValueTypes["robot_product_aggregate"]],
robot_product_by_pk?: [{	id:string},ValueTypes["robot_product"]],
robot_product_designer?: [{	/** distinct select on columns */
	...
	where?:ValueTypes["robot_product_designer_bool_exp"] | null},ValueTypes["robot_product_designer"]],
robot_product_designer_aggregate?: [{	/** distinct select on columns */
	distinct_on?:ValueTypes["robot_product_designer_select_column"][],	/** limit the number of rows returned */
	limit?:number | null,	/** skip the first n rows. Use only with order_by */
	offset?:number | null,	/** sort the rows by one or more columns */
	order_by?:ValueTypes["robot_product_designer_order_by"][],	/** filter the rows returned */
	where?:ValueTypes["robot_product_designer_bool_exp"] | null},ValueTypes["robot_product_designer_aggregate"]],
robot_product_designer_by_pk?: [{	eth_address:string,	product_id:string},ValueTypes["robot_product_designer"]],
...
count?: [{	columns?:ValueTypes["robot_order_select_column"][],	distinct?:boolean | null},boolean],
...
designers?: [{	/** distinct select on columns */
	...
	order_by?:ValueTypes["robot_product_designer_order_by"][],	/** filter the rows returned */
	where?:ValueTypes["robot_product_designer_bool_exp"] | null},ValueTypes["robot_product_designer"]],
designers_aggregate?: [{	/** distinct select on columns */
	distinct_on?:ValueTypes["robot_product_designer_select_column"][],	/** limit the number of rows returned */
	limit?:number | null,	/** skip the first n rows. Use only with order_by */
	offset?:number | null,	/** sort the rows by one or more columns */
	order_by?:ValueTypes["robot_product_designer_order_by"][],	/** filter the rows returned */
...
count?: [{	columns?:ValueTypes["robot_product_designer_select_column"][],	distinct?:boolean | null},boolean],
...
["robot_product_designer_aggregate_order_by"]: {
	...
	stddev_pop?:ValueTypes["robot_product_designer_stddev_pop_order_by"] | null,
	stddev_samp?:ValueTypes["robot_product_designer_stddev_samp_order_by"] | null,
